...
app
	...
	.factory("SoundNotification", ["$log", function($log){
...
app.
	...
	.filter('filterSpots', ["$log", "settingsService", "SoundNotification", "SpotsService", "loggerService", function($log, settingsService, SoundNotification, SpotsService, loggerService){
...
app
    ...
    .factory('loggerService', ["$log", "$filter", function($log,$filter){
...
app
	...
	.controller("spotfilterController", ["$scope", "$window", "SpotsService", "loggerService", "alertService", function($scope, $window, SpotsService, loggerService, alertService){
	...
	.factory('SpotsService', ["$timeout", "$http", "$log", "$q", "SoundNotification", "alertService", function($timeout, $http, $log, $q, SoundNotification, alertService){
